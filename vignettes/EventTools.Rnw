...
of $1.2$. The study settings (not the simulated data) can be visualized using the 
(yet to be released) \texttt{nonproportionalHazards} package (Figure~\ref{fig:nphz}.
